...
const FilterContentModal = ({ opened, onClose }) => (
  <PopupModal opened={opened} onClose={onClose} title={'💡 콘텐츠 한 눈에 살펴보기'}>
    ...
    <Text mt="20px">
      {
        '향상된 필터링 옵션을 사용하여 알림 콘텐츠를 커뮤니티 또는 카테고리 별로 관리할 수 있습니다. 스레드를 필터링하여 원하는 답변을 찾거나, 관심 있는 새 스레드를 탐색하거나, 여전히 도움이 필요한 다른 회원의 질문을 찾을 수 있습니다. Apple 지원 커뮤니티에 로그인한 상태라면 프로파일 또는 오른쪽 상단 모서리의 탐색 막대에서 알림 보기에 접근할 수 있습니다.'
      }
    </Text>
    <Text mt="20px">
